...
public class NumberUtilsManualTest {
    ...
    private static void testToInt() {
        ...
        testCaseToInt(null, -1, -1, "null 输入");
    }
    private static void testCaseToInt(String input, int defaultValue, int expected, String
            description) {
    ...
    private static void testIsDigits() {
        ...
        testCaseIsDigits(null, false, "null 输入");
    }
